...
class MyOperatorButton extends Button implements ActionListener {
    ...
    MyOperatorButton(int x, int y, int width, int height, String cap, BT11 clc) {
        super(cap);
        setBounds(x, y, width, height);
        this.cl = clc;
        this.cl.add(this);
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (opText.equals("1/x")) {
            try {
                ...
                cl.displayLabel.setText(BT11.getFormattedText(tempd));
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        switch (memop) {
            case 'C':
                ...
                break;
            case 'R':
                cl.displayLabel.setText(BT11.getFormattedText(cl.memValue));
                break;
            case 'S':
                cl.memValue = 0.0;
            case '+':
...
class MySpecialButton extends Button implements ActionListener {
    ...
    MySpecialButton(int x, int y, int width, int height, String cap, BT11 clc) {
        super(cap);
        setBounds(x, y, width, height);
        this.cl = clc;
        this.cl.add(this);
